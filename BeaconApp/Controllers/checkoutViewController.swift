...
class checkoutViewController: UIViewController {
    ...
    let BTGetTokenAPI = "http://ec2-3-88-222-179.compute-1.amazonaws.com/api/payments/getToken"
    let BTCheckoutAPI = "http://ec2-3-88-222-179.compute-1.amazonaws.com/api/payments/checkout"
